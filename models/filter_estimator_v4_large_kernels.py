...
class AudioFilterEstimatorFreq(nn.Module):
    ...
    def __init__(self, input_channels=2, output_shape = (3, 2048)):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(input_channels, 32, kernel_size=(31, 3), stride=(2, 1), padding=(15, 1), bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(32),
            nn.Conv2d(32, 64, kernel_size=(21, 3), stride=(2, 1), padding=(10, 1), bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(64),
            nn.Conv2d(64, 128, kernel_size=(11, 3), stride=(2, 1), padding=(5, 1), bias=False),
            nn.ReLU(),
            nn.BatchNorm2d(128),
