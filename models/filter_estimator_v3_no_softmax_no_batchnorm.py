...
class AudioFilterEstimatorFreq(nn.Module):
    ...
    def __init__(self, input_channels=2, output_shape=(3, 2048)):
        ...
        self.encoder = nn.Sequential(
            ...
            # nn.BatchNorm2d(32),
            nn.Conv2d(
                32, 64, kernel_size=(5, 3), stride=(2, 1), padding=(2, 1), bias=False
            ),
            nn.ReLU(),
            # nn.BatchNorm2d(64),
            nn.Conv2d(
                64, 128, kernel_size=(5, 3), stride=(2, 1), padding=(2, 1), bias=False
            ),
            nn.ReLU(),
            # nn.BatchNorm2d(128),
            nn.Conv2d(
                128, 256, kernel_size=(5, 3), stride=(2, 1), padding=(2, 1), bias=False
            ),
            nn.ReLU(),
            # nn.BatchNorm2d(256),
