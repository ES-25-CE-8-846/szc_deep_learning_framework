...
class TestDataloading(unittest.TestCase):
    def test_parsing(self):
        ...
        self.assertTrue(self.test_dataloader[0]['sound'].size()[1] == self.test_dataloader[0]['sr'] * (sound_snips_len_ms/1000)) 
    ...
    def test_auralizer(self): 
        ...
        test_trainer = trainer.Trainer(dataloader=torch_dataloader, loss_function=None, model=None)
    ...
    def test_filter_apply_and_auralize(self):
        ...
        for i, data_dict in enumerate(torch_dataloader):
            ...
            print(f"filtered sound shape {filtered_sound.size()} ")
            print(f"auralized sound shape {auralized_sound_bz.size()} bz, {auralized_sound_dz.size()} dz ")
    ...
    def test_sound_filter(self):
        ...
        test_dataloader = dataloader.DefaultDataset(sound_dataset_root='./testing_data/audio_raw/',
                                                    rir_dataset_root='./testing_data/rirs/test_rirs/dataset/shoebox/alfredo-request/test/',
                                                    sound_snip_len=sound_snips_len_ms,
                                                    override_existing=True,
                                                    filter_by_std=0.02,
        ...
        self.assertTrue(test_dataloader.filter_snippets(filter_by_std=1.0, filter_by_mean=1.0, sound_tensor=test_sound_1))
        self.assertTrue(test_dataloader.filter_snippets(filter_by_std=None, filter_by_mean=1.0, sound_tensor=test_sound_1))
        self.assertTrue(test_dataloader.filter_snippets(filter_by_std=1.0, filter_by_mean=None, sound_tensor=test_sound_1))

        self.assertFalse(test_dataloader.filter_snippets(filter_by_std=1.0, filter_by_mean=1.0, sound_tensor=test_sound_3))
        self.assertFalse(test_dataloader.filter_snippets(filter_by_std=None, filter_by_mean=1.0, sound_tensor=test_sound_3))
        self.assertFalse(test_dataloader.filter_snippets(filter_by_std=1.0, filter_by_mean=None, sound_tensor=test_sound_3))

        self.assertFalse(test_dataloader.filter_snippets(filter_by_std=1.0, filter_by_mean=1.0, sound_tensor=test_sound_2))
        self.assertFalse(test_dataloader.filter_snippets(filter_by_std=1.0, filter_by_mean=None, sound_tensor=test_sound_2))
        self.assertTrue(test_dataloader.filter_snippets(filter_by_std=None, filter_by_mean=1.0, sound_tensor=test_sound_2))
